...
const FooterComponent = () => {
    return (
        <footer className="bg-charcoal-950 text-white border-t border-gold-400/20 mt-auto">
            <div className="container-custom py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div className="text-center md:text-left">
                        <h3 className="text-lg font-display font-semibold text-gold-400 mb-4">About Us</h3>
                        <p className="text-white/70 mb-4 leading-relaxed">
                            Experience the epitome of luxury and comfort in our meticulously designed 
                            accommodations, where every detail is crafted to provide an unforgettable stay.
                        </p>
                        <div className="flex space-x-4 justify-center md:justify-start">
                            <a href="#" className="text-white/50 hover:text-gold-400 transition-colors">
                    ...
                    <div className="text-center">
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/home" className="text-white/70 hover:text-gold-400 transition-colors">Home</Link>
                            </li>
                            <li>
                                <Link to="/rooms" className="text-white/70 hover:text-gold-400 transition-colors">Rooms & Suites</Link>
                            </li>
                            <li>
                                <Link to="/find-booking" className="text-white/70 hover:text-gold-400 transition-colors">Reservations</Link>
                            </li>
                            <li>
                                <Link to="/login" className="text-white/70 hover:text-gold-400 transition-colors">Member Access</Link>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-white/10 mt-10 pt-8 text-center">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex space-x-4 mt-4 md:mt-0">
                            ...
                            <a href="#" className="text-white/50 text-sm hover:text-gold-400 transition-colors">Terms of Service</a>
                        </div>
                    </div>
                </div>
            </div>
